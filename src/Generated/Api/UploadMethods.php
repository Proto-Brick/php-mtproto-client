...
final readonly class UploadMethods
{
    ...
    {
        return (bool) $this->client->callSync(new SaveFilePartRequest(fileId: $fileId, filePart: $filePart, bytes: $bytes));
    }
    ...
    {
        return $this->client->callSync(new GetFileRequest(location: $location, offset: $offset, limit: $limit, precise: $precise, cdnSupported: $cdnSupported));
    }
    ...
    {
        return (bool) $this->client->callSync(new SaveBigFilePartRequest(fileId: $fileId, filePart: $filePart, fileTotalParts: $fileTotalParts, bytes: $bytes));
    }
    ...
    {
        return $this->client->callSync(new GetWebFileRequest(location: $location, offset: $offset, limit: $limit));
    }
    ...
    {
        return $this->client->callSync(new GetCdnFileRequest(fileToken: $fileToken, offset: $offset, limit: $limit));
    }
    ...
    {
        return $this->client->callSync(new ReuploadCdnFileRequest(fileToken: $fileToken, requestToken: $requestToken));
    }
    ...
    {
        return $this->client->callSync(new GetCdnFileHashesRequest(fileToken: $fileToken, offset: $offset));
    }
    ...
    {
        return $this->client->callSync(new GetFileHashesRequest(location: $location, offset: $offset));
    }
}