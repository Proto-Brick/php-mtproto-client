...
final readonly class StickersMethods
{
    ...
    public function createStickerSet(AbstractInputUser|string|int $userId, string $title, string $shortName, array $stickers, ?bool $masks = null, ?bool $emojis = null, ?bool $textColor = null, ?AbstractInputDocument $thumb = null, ?string $software = null): ?AbstractStickerSet
    {
        ...
        return $this->client->callSync(new CreateStickerSetRequest(userId: $userId, title: $title, shortName: $shortName, stickers: $stickers, masks: $masks, emojis: $emojis, textColor: $textColor, thumb: $thumb, software: $software));
    }
    ...
    {
        return $this->client->callSync(new RemoveStickerFromSetRequest(sticker: $sticker));
    }
    ...
    {
        return $this->client->callSync(new ChangeStickerPositionRequest(sticker: $sticker, position: $position));
    }
    ...
    {
        return $this->client->callSync(new AddStickerToSetRequest(stickerset: $stickerset, sticker: $sticker));
    }
    ...
    {
        return $this->client->callSync(new SetStickerSetThumbRequest(stickerset: $stickerset, thumb: $thumb, thumbDocumentId: $thumbDocumentId));
    }
    ...
    {
        return (bool) $this->client->callSync(new CheckShortNameRequest(shortName: $shortName));
    }
    ...
    {
        return $this->client->callSync(new SuggestShortNameRequest(title: $title));
    }
    ...
    {
        return $this->client->callSync(new ChangeStickerRequest(sticker: $sticker, emoji: $emoji, maskCoords: $maskCoords, keywords: $keywords));
    }
    ...
    {
        return $this->client->callSync(new RenameStickerSetRequest(stickerset: $stickerset, title: $title));
    }
    ...
    {
        return (bool) $this->client->callSync(new DeleteStickerSetRequest(stickerset: $stickerset));
    }
    ...
    {
        return $this->client->callSync(new ReplaceStickerRequest(sticker: $sticker, newSticker: $newSticker));
    }
}