 ...
 */
final class GetChannelDefaultEmojiStatusesRequest extends TlObject
{
    public const CONSTRUCTOR_ID = 1999087573;
    
    public string $_ = 'account.getChannelDefaultEmojiStatuses';
