...
final class InitTakeoutSessionRequest extends TlObject
{
    ...
    public string $predicate = 'account.initTakeoutSession';
     ...
     * @param true|null $messageUsers
     * @param true|null $messageChats
     * @param true|null $messageMegagroups
     * @param true|null $messageChannels
     * @param true|null $files
     * @param int|null $fileMaxSize
     */
    public function __construct(
        public readonly ?true $contacts = null,
        public readonly ?true $messageUsers = null,
        public readonly ?true $messageChats = null,
        public readonly ?true $messageMegagroups = null,
        public readonly ?true $messageChannels = null,
        public readonly ?true $files = null,
