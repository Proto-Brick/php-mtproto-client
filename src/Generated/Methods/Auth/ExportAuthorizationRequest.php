...
use DigitalStars\MtprotoClient\Generated\Types\Auth\AbstractExportedAuthorization;
...
{
    public const CONSTRUCTOR_ID = 3854565325;
    
    public string $_ = 'auth.exportAuthorization';
    ...
    {
        return AbstractExportedAuthorization::class;
    }
    /**
     * @param int $dcId
     */
