...
use DigitalStars\MtprotoClient\Generated\Types\Bots\AbstractPopularAppBots;
...
{
    public const CONSTRUCTOR_ID = 3260088722;
    
    public string $_ = 'bots.getPopularAppBots';
    ...
    {
        return AbstractPopularAppBots::class;
    }
    /**
     * @param string $offset
     * @param int $limit
