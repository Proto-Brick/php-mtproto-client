 ...
 */
final class TogglePreHistoryHiddenRequest extends RpcRequest
{
    public const CONSTRUCTOR_ID = 0xeabbb94c;
    
    public string $predicate = 'channels.togglePreHistoryHidden';
