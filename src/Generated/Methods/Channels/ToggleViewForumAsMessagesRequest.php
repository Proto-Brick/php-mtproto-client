 ...
 */
final class ToggleViewForumAsMessagesRequest extends RpcRequest
{
    public const CONSTRUCTOR_ID = 0x9738bb15;
    
    public string $predicate = 'channels.toggleViewForumAsMessages';
