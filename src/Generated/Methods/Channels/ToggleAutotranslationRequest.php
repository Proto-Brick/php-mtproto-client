 ...
 */
final class ToggleAutotranslationRequest extends RpcRequest
{
    public const CONSTRUCTOR_ID = 0x167fc0a1;
    
    public string $predicate = 'channels.toggleAutotranslation';
