...
use DigitalStars\MtprotoClient\Generated\Types\Messages\AbstractArchivedStickers;
...
{
    public const CONSTRUCTOR_ID = 1475442322;
    ...
    {
        return AbstractArchivedStickers::class;
    }
    /**
     * @param int $offsetId
     * @param int $limit
