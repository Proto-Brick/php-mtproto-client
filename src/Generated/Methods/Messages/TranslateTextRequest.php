...
use DigitalStars\MtprotoClient\Generated\Types\Messages\AbstractTranslatedText;
...
{
    public const CONSTRUCTOR_ID = 1662529584;
    ...
    {
        return AbstractTranslatedText::class;
    }
    /**
     * @param string $toLang
     * @param AbstractInputPeer|null $peer
     * @param list<int>|null $id
     * @param list<AbstractTextWithEntities>|null $text
     */
