...
use DigitalStars\MtprotoClient\Generated\Types\Base\AbstractAvailableEffect;
...
{
    public const CONSTRUCTOR_ID = 3185271150;
    
    public string $_ = 'messages.availableEffects';
    
    /**
     * @param int $hash
     * @param list<AbstractAvailableEffect> $effects
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $effects = $deserializer->vectorOfObjects($stream, [AbstractAvailableEffect::class, 'deserialize']);
