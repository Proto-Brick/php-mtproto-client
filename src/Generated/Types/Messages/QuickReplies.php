...
use DigitalStars\MtprotoClient\Generated\Types\Base\AbstractQuickReply;
...
{
    public const CONSTRUCTOR_ID = 3331155605;
    
    public string $_ = 'messages.quickReplies';
    
    /**
     * @param list<AbstractQuickReply> $quickReplies
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $quickReplies = $deserializer->vectorOfObjects($stream, [AbstractQuickReply::class, 'deserialize']);
