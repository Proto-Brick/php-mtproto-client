...
{
    public const CONSTRUCTOR_ID = 2835028353;
    
    public string $_ = 'updates.differenceSlice';
     ...
     * @param AbstractState $intermediateState
     */
    public function __construct(
        ...
        public readonly AbstractState $intermediateState
    ) {}
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $intermediateState = AbstractState::deserialize($deserializer, $stream);
            return new self(
            $newMessages,
