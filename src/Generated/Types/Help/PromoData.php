...
use DigitalStars\MtprotoClient\Generated\Types\Base\PendingSuggestion;
...
final class PromoData extends AbstractPromoData
{
    ...
    public function serialize(): string
    {
        ...
        if ($this->customPendingSuggestion !== null) $flags |= (1 << 4);
    ...
    public static function deserialize(string &$stream): static
    {
        ...
        $peer = ($flags & (1 << 3)) ? AbstractPeer::deserialize($stream) : null;
        ...
        $customPendingSuggestion = ($flags & (1 << 4)) ? PendingSuggestion::deserialize($stream) : null;
