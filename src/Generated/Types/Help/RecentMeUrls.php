...
use ProtoBrick\MTProtoClient\Generated\Types\Base\AbstractRecentMeUrl;
...
final class RecentMeUrls extends TlObject
{
    ...
    public static function deserialize(string $__payload, &$__offset): static
    {
        ...
        $urls = Deserializer::vectorOfObjects($__payload, $__offset, [AbstractRecentMeUrl::class, 'deserialize']);
