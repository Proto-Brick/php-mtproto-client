...
{
    public const CONSTRUCTOR_ID = 3709368366;
    ...
    public function serialize(Serializer $serializer): string
    {
        ...
        $buffer .= (new DataJSON(json_encode($this->config)))->serialize($serializer);
        return $buffer;
    }
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $config = json_decode((DataJSON::deserialize($deserializer, $stream))->data, true);
            return new self(
            $hash,
            $config
        );
