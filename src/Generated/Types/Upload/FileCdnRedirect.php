...
use DigitalStars\MtprotoClient\Generated\Types\Base\AbstractFileHash;
...
{
    public const CONSTRUCTOR_ID = 4052539972;
     ...
     * @param list<AbstractFileHash> $fileHashes
     */
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $fileHashes = $deserializer->vectorOfObjects($stream, [AbstractFileHash::class, 'deserialize']);
            return new self(
            $dcId,
            $fileToken,
            $encryptionKey,
