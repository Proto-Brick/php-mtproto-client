...
use DigitalStars\MtprotoClient\Generated\Types\Base\AbstractContact;
...
{
    public const CONSTRUCTOR_ID = 3941105218;
    
    public string $_ = 'contacts.contacts';
    
    /**
     * @param list<AbstractContact> $contacts
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $contacts = $deserializer->vectorOfObjects($stream, [AbstractContact::class, 'deserialize']);
