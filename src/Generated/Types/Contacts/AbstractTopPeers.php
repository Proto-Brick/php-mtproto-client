...
abstract class AbstractTopPeers extends TlObject
{
    public static function deserialize(string $__payload, int &$__offset): static
    {
        ...
        return match ($constructorId) {
            0xde266ef5 => TopPeersNotModified::deserialize($__payload, $__offset),
            0x70b772a8 => TopPeers::deserialize($__payload, $__offset),
            0xb52c939d => TopPeersDisabled::deserialize($__payload, $__offset),
