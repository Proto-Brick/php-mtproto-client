...
abstract class AbstractResetPasswordResult extends TlObject
{
    public static function deserialize(string $__payload, int &$__offset): static
    {
        ...
        return match ($constructorId) {
            0xe3779861 => ResetPasswordFailedWait::deserialize($__payload, $__offset),
            0xe9effc7d => ResetPasswordRequestedWait::deserialize($__payload, $__offset),
            0xe926d63e => ResetPasswordOk::deserialize($__payload, $__offset),
