...
{
    public const CONSTRUCTOR_ID = 1421174295;
    
    public string $_ = 'webPageAttributeTheme';
    
    /**
     * @param list<AbstractDocument>|null $documents
     * @param AbstractThemeSettings|null $settings
     */
    public function __construct(
        public readonly ?array $documents = null,
        public readonly ?AbstractThemeSettings $settings = null
    ) {}
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $settings = ($flags & (1 << 1)) ? AbstractThemeSettings::deserialize($deserializer, $stream) : null;
            return new self(
            $documents,
            $settings
        );
