...
abstract class AbstractMessageAction extends TlObject
{
    public static function deserialize(string $__payload, int &$__offset): static
    {
        ...
        return match ($constructorId) {
            ...
            0xaa786345 => MessageActionSetChatTheme::deserialize($__payload, $__offset),
            ...
            0x6c6274fa => MessageActionGiftPremium::deserialize($__payload, $__offset),
            ...
            0x56d03994 => MessageActionGiftCode::deserialize($__payload, $__offset),
            ...
            0x4717e8a4 => MessageActionStarGift::deserialize($__payload, $__offset),
            0x34f762f3 => MessageActionStarGiftUnique::deserialize($__payload, $__offset),
            ...
            default => throw new RuntimeException(
                sprintf(
                    'Unknown constructor ID for type MessageAction. Received ID: 0x%s (signed: %d, unsigned: %u)',
                    dechex($constructorId),
                    unpack('l', pack('V', $constructorId))[1],
                    $constructorId
                )
            ),
        };
