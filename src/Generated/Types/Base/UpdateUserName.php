...
{
    public const CONSTRUCTOR_ID = 2810480932;
     ...
     * @param list<AbstractUsername> $usernames
     */
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $usernames = $deserializer->vectorOfObjects($stream, [AbstractUsername::class, 'deserialize']);
            return new self(
            $userId,
            $firstName,
            $lastName,
