 ...
 */
final class SponsoredMessage extends AbstractSponsoredMessage
{
    public const CONSTRUCTOR_ID = 1301522832;
    
    public string $_ = 'sponsoredMessage';
    ...
    public function __construct(
        ...
        public readonly ?bool $canReport = null,
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $color = ($flags & (1 << 13)) ? AbstractPeerColor::deserialize($deserializer, $stream) : null;
