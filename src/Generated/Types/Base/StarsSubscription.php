 ...
 */
final class StarsSubscription extends AbstractStarsSubscription
{
    public const CONSTRUCTOR_ID = 779004698;
     ...
     * @param int $untilDate
     * @param AbstractStarsSubscriptionPricing $pricing
    ...
    public function __construct(
        ...
        public readonly AbstractStarsSubscriptionPricing $pricing,
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $pricing = AbstractStarsSubscriptionPricing::deserialize($deserializer, $stream);
