 ...
 */
final class BusinessBotRecipients extends AbstractBusinessBotRecipients
{
    public const CONSTRUCTOR_ID = 3096245107;
    
    public string $_ = 'businessBotRecipients';
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $users = ($flags & (1 << 4)) ? $deserializer->vectorOfLongs($stream) : null;
        $excludeUsers = ($flags & (1 << 6)) ? $deserializer->vectorOfLongs($stream) : null;
            return new self(
            $existingChats,
            $newChats,
            $contacts,
