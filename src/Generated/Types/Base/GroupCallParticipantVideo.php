 ...
 */
final class GroupCallParticipantVideo extends AbstractGroupCallParticipantVideo
{
    public const CONSTRUCTOR_ID = 1735736008;
    
    public string $_ = 'groupCallParticipantVideo';
    
    /**
     * @param string $endpoint
     * @param list<AbstractGroupCallParticipantVideoSourceGroup> $sourceGroups
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $sourceGroups = $deserializer->vectorOfObjects($stream, [AbstractGroupCallParticipantVideoSourceGroup::class, 'deserialize']);
