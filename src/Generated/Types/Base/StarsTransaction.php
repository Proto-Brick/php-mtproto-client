 ...
 */
final class StarsTransaction extends AbstractStarsTransaction
{
    public const CONSTRUCTOR_ID = 1692387622;
    
    public string $_ = 'starsTransaction';
    
    /**
     * @param string $id
     * @param AbstractStarsAmount $stars
     * @param int $date
    ...
    public function __construct(
        ...
        public readonly AbstractStarsAmount $stars,
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $stars = AbstractStarsAmount::deserialize($deserializer, $stream);
        ...
        $stargift = ($flags & (1 << 14)) ? AbstractStarGift::deserialize($deserializer, $stream) : null;
        ...
        $starrefAmount = ($flags & (1 << 17)) ? AbstractStarsAmount::deserialize($deserializer, $stream) : null;
            return new self(
            $id,
            $stars,
            $date,
