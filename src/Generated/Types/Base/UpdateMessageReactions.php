...
{
    public const CONSTRUCTOR_ID = 1578843320;
     ...
     * @param int $msgId
     * @param AbstractMessageReactions $reactions
     * @param int|null $topMsgId
     */
    public function __construct(
        public readonly AbstractPeer $peer,
        public readonly int $msgId,
        public readonly AbstractMessageReactions $reactions,
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $reactions = AbstractMessageReactions::deserialize($deserializer, $stream);
            return new self(
            $peer,
            $msgId,
            $reactions,
