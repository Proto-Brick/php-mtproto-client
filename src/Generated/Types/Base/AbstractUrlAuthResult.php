...
abstract class AbstractUrlAuthResult extends TlObject
{
    public static function deserialize(string $__payload, int &$__offset): static
    {
        ...
        return match ($constructorId) {
            0x92d33a0e => UrlAuthResultRequest::deserialize($__payload, $__offset),
            0x8f8c0e4e => UrlAuthResultAccepted::deserialize($__payload, $__offset),
            0xa9d6db1f => UrlAuthResultDefault::deserialize($__payload, $__offset),
