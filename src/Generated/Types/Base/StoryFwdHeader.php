...
final class StoryFwdHeader extends TlObject
{
    ...
    public static function deserialize(string $__payload, &$__offset): static
    {
        ...
        $from = (($flags & (1 << 0)) !== 0) ? AbstractPeer::deserialize($__payload, $__offset) : null;
        $fromName = (($flags & (1 << 1)) !== 0) ? Deserializer::bytes($__payload, $__offset) : null;
        $storyId = (($flags & (1 << 2)) !== 0) ? Deserializer::int32($__payload, $__offset) : null;
