...
{
    public const CONSTRUCTOR_ID = 2685298646;
     ...
     * @param list<AbstractThemeSettings>|null $settings
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $settings = ($flags & (1 << 3)) ? $deserializer->vectorOfObjects($stream, [AbstractThemeSettings::class, 'deserialize']) : null;
