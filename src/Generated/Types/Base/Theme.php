...
final class Theme extends TlObject
{
    ...
    public static function deserialize(string $__payload, &$__offset): static
    {
        ...
        $document = (($flags & (1 << 2)) !== 0) ? AbstractDocument::deserialize($__payload, $__offset) : null;
        $settings = (($flags & (1 << 3)) !== 0) ? Deserializer::vectorOfObjects($__payload, $__offset, [ThemeSettings::class, 'deserialize']) : null;
        $emoticon = (($flags & (1 << 6)) !== 0) ? Deserializer::bytes($__payload, $__offset) : null;
        $installsCount = (($flags & (1 << 4)) !== 0) ? Deserializer::int32($__payload, $__offset) : null;
