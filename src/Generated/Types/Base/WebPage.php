...
{
    public const CONSTRUCTOR_ID = 3902555570;
     ...
     * @param AbstractPage|null $cachedPage
    ...
    public function __construct(
        ...
        public readonly ?AbstractPage $cachedPage = null,
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $cachedPage = ($flags & (1 << 10)) ? AbstractPage::deserialize($deserializer, $stream) : null;
