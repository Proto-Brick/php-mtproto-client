...
{
    public const CONSTRUCTOR_ID = 1530447553;
    
    public string $_ = 'inputMediaUploadedDocument';
    
    /**
     * @param AbstractInputFile $file
     * @param string $mimeType
     * @param list<AbstractDocumentAttribute> $attributes
     * @param bool|null $nosoundVideo
     * @param bool|null $forceFile
    ...
    public function __construct(
        ...
        public readonly ?bool $nosoundVideo = null,
        public readonly ?bool $forceFile = null,
