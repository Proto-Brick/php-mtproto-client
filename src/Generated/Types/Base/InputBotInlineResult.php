...
{
    public const CONSTRUCTOR_ID = 2294256409;
     ...
     * @param AbstractInputWebDocument|null $thumb
     * @param AbstractInputWebDocument|null $content
     */
    public function __construct(
        ...
        public readonly ?AbstractInputWebDocument $thumb = null,
        public readonly ?AbstractInputWebDocument $content = null
    ) {}
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $thumb = ($flags & (1 << 4)) ? AbstractInputWebDocument::deserialize($deserializer, $stream) : null;
        $content = ($flags & (1 << 5)) ? AbstractInputWebDocument::deserialize($deserializer, $stream) : null;
