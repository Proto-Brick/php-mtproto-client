...
final class SuggestedPost extends TlObject
{
    ...
    public static function deserialize(string &$stream): static
    {
        ...
        $accepted = ($flags & (1 << 1)) ? true : null;
        $rejected = ($flags & (1 << 2)) ? true : null;
        $price = ($flags & (1 << 3)) ? AbstractStarsAmount::deserialize($stream) : null;
        $scheduleDate = ($flags & (1 << 0)) ? Deserializer::int32($stream) : null;
