 ...
 */
final class InputSecureValue extends AbstractInputSecureValue
{
    public const CONSTRUCTOR_ID = 3676426407;
    
    public string $_ = 'inputSecureValue';
    
    /**
     * @param AbstractSecureValueType $type
     * @param AbstractSecureData|null $data
    ...
    public function __construct(
        ...
        public readonly ?AbstractSecureData $data = null,
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $data = ($flags & (1 << 0)) ? AbstractSecureData::deserialize($deserializer, $stream) : null;
