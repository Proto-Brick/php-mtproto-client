...
abstract class AbstractSecurePasswordKdfAlgo extends TlObject
{
    public static function deserialize(string $__payload, int &$__offset): static
    {
        ...
        return match ($constructorId) {
            0x4a8537 => SecurePasswordKdfAlgoUnknown::deserialize($__payload, $__offset),
            0xbbf2dda0 => SecurePasswordKdfAlgoPBKDF2HMACSHA512iter100000::deserialize($__payload, $__offset),
            0x86471d92 => SecurePasswordKdfAlgoSHA512::deserialize($__payload, $__offset),
