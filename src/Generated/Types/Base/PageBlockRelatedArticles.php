...
{
    public const CONSTRUCTOR_ID = 370236054;
    
    public string $_ = 'pageBlockRelatedArticles';
    
    /**
     * @param AbstractRichText $title
     * @param list<AbstractPageRelatedArticle> $articles
     */
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $articles = $deserializer->vectorOfObjects($stream, [AbstractPageRelatedArticle::class, 'deserialize']);
            return new self(
            $title,
            $articles
        );
