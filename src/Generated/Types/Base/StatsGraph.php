...
{
    public const CONSTRUCTOR_ID = 2393138358;
    ...
    public function serialize(Serializer $serializer): string
    {
        ...
        $buffer .= (new DataJSON(json_encode($this->json)))->serialize($serializer);
        if ($flags & (1 << 0)) {
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $json = json_decode((DataJSON::deserialize($deserializer, $stream))->data, true);
