...
{
    public const CONSTRUCTOR_ID = 810769141;
    ...
    public function serialize(Serializer $serializer): string
    {
        ...
        if ($flags & (1 << 7)) {
            $buffer .= (new DataJSON(json_encode($this->customParameters)))->serialize($serializer);
        }
        return $buffer;
    }
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $customParameters = ($flags & (1 << 7)) ? json_decode((DataJSON::deserialize($deserializer, $stream))->data, true) : null;
            return new self(
            $id,
            $accessHash,
            $date,
