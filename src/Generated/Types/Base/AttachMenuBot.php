 ...
 */
final class AttachMenuBot extends AbstractAttachMenuBot
{
    public const CONSTRUCTOR_ID = 3641544190;
     ...
     * @param list<AbstractAttachMenuBotIcon> $icons
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $icons = $deserializer->vectorOfObjects($stream, [AbstractAttachMenuBotIcon::class, 'deserialize']);
            return new self(
            $botId,
            $shortName,
            $icons,
