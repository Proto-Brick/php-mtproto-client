...
{
    public const CONSTRUCTOR_ID = 2948336091;
     ...
     * @param AbstractMessageFwdHeader|null $replyFrom
    ...
    public function __construct(
        ...
        public readonly ?AbstractMessageFwdHeader $replyFrom = null,
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $replyFrom = ($flags & (1 << 5)) ? AbstractMessageFwdHeader::deserialize($deserializer, $stream) : null;
