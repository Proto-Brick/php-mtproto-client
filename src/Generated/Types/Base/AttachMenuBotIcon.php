 ...
 */
final class AttachMenuBotIcon extends AbstractAttachMenuBotIcon
{
    public const CONSTRUCTOR_ID = 2997303403;
     ...
     * @param list<AbstractAttachMenuBotIconColor>|null $colors
     */
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $colors = ($flags & (1 << 0)) ? $deserializer->vectorOfObjects($stream, [AbstractAttachMenuBotIconColor::class, 'deserialize']) : null;
            return new self(
            $name,
            $icon,
            $colors
