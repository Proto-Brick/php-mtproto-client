...
{
    public const CONSTRUCTOR_ID = 640893467;
     ...
     * @param list<AbstractBotInfo>|null $botInfo
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $botInfo = ($flags & (1 << 3)) ? $deserializer->vectorOfObjects($stream, [AbstractBotInfo::class, 'deserialize']) : null;
        $pinnedMsgId = ($flags & (1 << 6)) ? $deserializer->int32($stream) : null;
        $folderId = ($flags & (1 << 11)) ? $deserializer->int32($stream) : null;
        $call = ($flags & (1 << 12)) ? AbstractInputGroupCall::deserialize($deserializer, $stream) : null;
