...
abstract class AbstractRequirementToContact extends TlObject
{
    public static function deserialize(string &$stream): static
    {
        ...
        return match ($constructorId) {
            RequirementToContactEmpty::CONSTRUCTOR_ID => RequirementToContactEmpty::deserialize($stream),
            RequirementToContactPremium::CONSTRUCTOR_ID => RequirementToContactPremium::deserialize($stream),
            RequirementToContactPaidMessages::CONSTRUCTOR_ID => RequirementToContactPaidMessages::deserialize($stream),
