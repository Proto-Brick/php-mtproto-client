...
abstract class AbstractRequirementToContact extends TlObject
{
    public static function deserialize(string $__payload, int &$__offset): static
    {
        ...
        return match ($constructorId) {
            0x50a9839 => RequirementToContactEmpty::deserialize($__payload, $__offset),
            0xe581e4e9 => RequirementToContactPremium::deserialize($__payload, $__offset),
            0xb4f67e93 => RequirementToContactPaidMessages::deserialize($__payload, $__offset),
