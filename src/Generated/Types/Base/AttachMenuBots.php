...
{
    public const CONSTRUCTOR_ID = 1011024320;
    
    public string $_ = 'attachMenuBots';
    
    /**
     * @param int $hash
     * @param list<AbstractAttachMenuBot> $bots
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $bots = $deserializer->vectorOfObjects($stream, [AbstractAttachMenuBot::class, 'deserialize']);
