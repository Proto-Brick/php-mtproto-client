...
{
    public const CONSTRUCTOR_ID = 3402974509;
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $address = ($flags & (1 << 0)) ? AbstractGeoPointAddress::deserialize($deserializer, $stream) : null;
            return new self(
            $coordinates,
            $geo,
            $address
