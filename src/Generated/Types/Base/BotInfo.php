...
{
    public const CONSTRUCTOR_ID = 912290611;
     ...
     * @param list<AbstractBotCommand>|null $commands
     * @param AbstractBotMenuButton|null $menuButton
     * @param string|null $privacyPolicyUrl
     * @param AbstractBotAppSettings|null $appSettings
     */
    public function __construct(
        ...
        public readonly ?AbstractBotAppSettings $appSettings = null
    ) {}
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $commands = ($flags & (1 << 2)) ? $deserializer->vectorOfObjects($stream, [AbstractBotCommand::class, 'deserialize']) : null;
        ...
        $appSettings = ($flags & (1 << 8)) ? AbstractBotAppSettings::deserialize($deserializer, $stream) : null;
            return new self(
            $hasPreviewMedias,
            $userId,
            $description,
