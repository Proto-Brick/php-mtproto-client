...
{
    public const CONSTRUCTOR_ID = 2486456898;
     ...
     * @param AbstractMessageFwdHeader|null $fwdFrom
     ...
     * @param AbstractMessageReactions|null $reactions
     ...
     * @param AbstractFactCheck|null $factcheck
     */
    public function __construct(
        ...
        public readonly ?AbstractMessageFwdHeader $fwdFrom = null,
        ...
        public readonly ?AbstractMessageReactions $reactions = null,
        ...
        public readonly ?AbstractFactCheck $factcheck = null
    ) {}
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $fwdFrom = ($flags & (1 << 2)) ? AbstractMessageFwdHeader::deserialize($deserializer, $stream) : null;
        ...
        $replies = ($flags & (1 << 23)) ? AbstractMessageReplies::deserialize($deserializer, $stream) : null;
        ...
        $reactions = ($flags & (1 << 20)) ? AbstractMessageReactions::deserialize($deserializer, $stream) : null;
        $restrictionReason = ($flags & (1 << 22)) ? $deserializer->vectorOfObjects($stream, [AbstractRestrictionReason::class, 'deserialize']) : null;
        ...
        $factcheck = ($flags2 & (1 << 3)) ? AbstractFactCheck::deserialize($deserializer, $stream) : null;
            return new self(
            $id,
            $peerId,
            $date,
