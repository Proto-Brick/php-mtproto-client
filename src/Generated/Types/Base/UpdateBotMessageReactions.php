...
{
    public const CONSTRUCTOR_ID = 164329305;
     ...
     * @param int $msgId
     * @param int $date
     * @param list<AbstractReactionCount> $reactions
     * @param int $qts
     */
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $reactions = $deserializer->vectorOfObjects($stream, [AbstractReactionCount::class, 'deserialize']);
