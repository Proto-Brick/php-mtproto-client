...
final class PageTableCell extends TlObject
{
    ...
    public static function deserialize(string &$stream): static
    {
        ...
        $text = (($flags & (1 << 7)) !== 0) ? AbstractRichText::deserialize($stream) : null;
        $colspan = (($flags & (1 << 1)) !== 0) ? Deserializer::int32($stream) : null;
        $rowspan = (($flags & (1 << 2)) !== 0) ? Deserializer::int32($stream) : null;
