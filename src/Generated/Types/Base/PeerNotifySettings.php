...
final class PeerNotifySettings extends TlObject
{
    ...
    public static function deserialize(string &$stream): static
    {
        ...
        $iosSound = ($flags & (1 << 3)) ? AbstractNotificationSound::deserialize($stream) : null;
        $androidSound = ($flags & (1 << 4)) ? AbstractNotificationSound::deserialize($stream) : null;
        $otherSound = ($flags & (1 << 5)) ? AbstractNotificationSound::deserialize($stream) : null;
        ...
        $storiesIosSound = ($flags & (1 << 8)) ? AbstractNotificationSound::deserialize($stream) : null;
        $storiesAndroidSound = ($flags & (1 << 9)) ? AbstractNotificationSound::deserialize($stream) : null;
        $storiesOtherSound = ($flags & (1 << 10)) ? AbstractNotificationSound::deserialize($stream) : null;
        return new self(
            $showPreviews,
            $silent,
            $muteUntil,
