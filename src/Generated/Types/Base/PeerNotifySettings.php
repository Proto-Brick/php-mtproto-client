...
final class PeerNotifySettings extends TlObject
{
    ...
    public static function deserialize(string $__payload, &$__offset): static
    {
        ...
        $iosSound = (($flags & (1 << 3)) !== 0) ? AbstractNotificationSound::deserialize($__payload, $__offset) : null;
        $androidSound = (($flags & (1 << 4)) !== 0) ? AbstractNotificationSound::deserialize($__payload, $__offset) : null;
        $otherSound = (($flags & (1 << 5)) !== 0) ? AbstractNotificationSound::deserialize($__payload, $__offset) : null;
        ...
        $storiesIosSound = (($flags & (1 << 8)) !== 0) ? AbstractNotificationSound::deserialize($__payload, $__offset) : null;
        $storiesAndroidSound = (($flags & (1 << 9)) !== 0) ? AbstractNotificationSound::deserialize($__payload, $__offset) : null;
        $storiesOtherSound = (($flags & (1 << 10)) !== 0) ? AbstractNotificationSound::deserialize($__payload, $__offset) : null;
