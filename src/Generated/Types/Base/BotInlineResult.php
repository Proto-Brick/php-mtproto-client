...
{
    public const CONSTRUCTOR_ID = 295067450;
    
    public string $_ = 'botInlineResult';
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $thumb = ($flags & (1 << 4)) ? AbstractWebDocument::deserialize($deserializer, $stream) : null;
        $content = ($flags & (1 << 5)) ? AbstractWebDocument::deserialize($deserializer, $stream) : null;
