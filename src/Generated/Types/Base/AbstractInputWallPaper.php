...
abstract class AbstractInputWallPaper extends TlObject
{
    public static function deserialize(string $__payload, int &$__offset): static
    {
        ...
        return match ($constructorId) {
            0xe630b979 => InputWallPaper::deserialize($__payload, $__offset),
            0x72091c80 => InputWallPaperSlug::deserialize($__payload, $__offset),
            0x967a462e => InputWallPaperNoFile::deserialize($__payload, $__offset),
