...
{
    public const CONSTRUCTOR_ID = 2755118061;
     ...
     * @param AbstractWallPaperSettings|null $settings
     */
    public function __construct(
        ...
        public readonly ?AbstractWallPaperSettings $settings = null
    ) {}
    ...
    public static function deserialize(Deserializer $deserializer, string &$stream): static
    {
        ...
        $settings = ($flags & (1 << 2)) ? AbstractWallPaperSettings::deserialize($deserializer, $stream) : null;
            return new self(
            $id,
            $accessHash,
            $slug,
