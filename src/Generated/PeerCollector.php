    ...
    public function collect(object $object, PeerManager $manager): void
    {
        switch ($object::class) {
            case \ProtoBrick\MTProtoClient\Generated\Types\Base\ChannelFull::class:
                if ($object->stories !== null) { $this->collect($object->stories, $manager); }
                return;

            case \ProtoBrick\MTProtoClient\Generated\Types\Base\Message::class:
                if ($object->replyTo !== null) { $this->collect($object->replyTo, $manager); }
            ...
            case \ProtoBrick\MTProtoClient\Generated\Types\Base\MessageMediaWebPage::class:
                if ($object->webpage !== null) { $this->collect($object->webpage, $manager); }
                return;

            case \ProtoBrick\MTProtoClient\Generated\Types\Base\MessageMediaInvoice::class:
                if ($object->extendedMedia !== null) { $this->collect($object->extendedMedia, $manager); }
                return;

            case \ProtoBrick\MTProtoClient\Generated\Types\Base\MessageMediaStory::class:
                if ($object->story !== null) { $this->collect($object->story, $manager); }
                return;

            case \ProtoBrick\MTProtoClient\Generated\Types\Base\MessageMediaPaidMedia::class:
                if ($object->extendedMedia !== null) { foreach ($object->extendedMedia as $item) { $this->collect($item, $manager); } }
                return;

            case \ProtoBrick\MTProtoClient\Generated\Types\Auth\SentCodeSuccess::class:
                if ($object->authorization !== null) { $this->collect($object->authorization, $manager); }
                return;

            case \ProtoBrick\MTProtoClient\Generated\Types\Auth\Authorization::class:
                if ($object->user !== null) { if ($object->user instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($object->user); } }
                return;
            ...
            case \ProtoBrick\MTProtoClient\Generated\Types\Messages\Dialogs::class:
                if ($object->messages !== null) { foreach ($object->messages as $item) { $this->collect($item, $manager); } }
                if ($object->chats !== null) { foreach ($object->chats as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                if ($object->users !== null) { foreach ($object->users as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                return;
            ...
            case \ProtoBrick\MTProtoClient\Generated\Types\Messages\ChatFull::class:
                if ($object->fullChat !== null) { $this->collect($object->fullChat, $manager); }
                if ($object->chats !== null) { foreach ($object->chats as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                if ($object->users !== null) { foreach ($object->users as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                return;

            case \ProtoBrick\MTProtoClient\Generated\Types\Base\UpdateNewMessage::class:
                if ($object->message !== null) { $this->collect($object->message, $manager); }
                return;
            ...
            case \ProtoBrick\MTProtoClient\Generated\Types\Base\UpdateDialogFilter::class:
                if ($object->filter !== null) { if ($object->filter instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($object->filter); } }
                return;
            ...
            case \ProtoBrick\MTProtoClient\Generated\Types\Base\UpdateBotNewBusinessMessage::class:
                if ($object->message !== null) { $this->collect($object->message, $manager); }
                if ($object->replyToMessage !== null) { $this->collect($object->replyToMessage, $manager); }
                return;
            ...
            case \ProtoBrick\MTProtoClient\Generated\Types\Base\UpdateSentPhoneCode::class:
                if ($object->sentCode !== null) { $this->collect($object->sentCode, $manager); }
                return;

            case \ProtoBrick\MTProtoClient\Generated\Types\Updates\Difference::class:
                if ($object->newMessages !== null) { foreach ($object->newMessages as $item) { $this->collect($item, $manager); } }
                if ($object->otherUpdates !== null) { foreach ($object->otherUpdates as $item) { $this->collect($item, $manager); } }
                if ($object->chats !== null) { foreach ($object->chats as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                if ($object->users !== null) { foreach ($object->users as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                return;
            ...
            case \ProtoBrick\MTProtoClient\Generated\Types\Base\UpdateShort::class:
                if ($object->update !== null) { $this->collect($object->update, $manager); }
                return;

            case \ProtoBrick\MTProtoClient\Generated\Types\Base\UpdatesCombined::class:
                if ($object->updates !== null) { foreach ($object->updates as $item) { $this->collect($item, $manager); } }
                if ($object->users !== null) { foreach ($object->users as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                if ($object->chats !== null) { foreach ($object->chats as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                return;
            ...
            case \ProtoBrick\MTProtoClient\Generated\Types\Base\WebPage::class:
                if ($object->cachedPage !== null) { $this->collect($object->cachedPage, $manager); }
                if ($object->attributes !== null) { foreach ($object->attributes as $item) { $this->collect($item, $manager); } }
                return;

            case \ProtoBrick\MTProtoClient\Generated\Types\Base\ChatInviteAlready::class:
                if ($object->chat !== null) { if ($object->chat instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($object->chat); } }
                return;

            case \ProtoBrick\MTProtoClient\Generated\Types\Base\ChatInvite::class:
                if ($object->participants !== null) { foreach ($object->participants as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                return;
            ...
            case \ProtoBrick\MTProtoClient\Generated\Types\Base\PageBlockCover::class:
                if ($object->cover !== null) { $this->collect($object->cover, $manager); }
                return;

            case \ProtoBrick\MTProtoClient\Generated\Types\Base\PageBlockEmbedPost::class:
                if ($object->blocks !== null) { foreach ($object->blocks as $item) { $this->collect($item, $manager); } }
                return;

            case \ProtoBrick\MTProtoClient\Generated\Types\Base\PageBlockCollage::class:
                if ($object->items !== null) { foreach ($object->items as $item) { $this->collect($item, $manager); } }
                return;
            ...
            case \ProtoBrick\MTProtoClient\Generated\Types\Base\PageBlockChannel::class:
                if ($object->channel !== null) { if ($object->channel instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($object->channel); } }
                return;
            ...
            case \ProtoBrick\MTProtoClient\Generated\Types\Payments\PaymentResult::class:
                if ($object->updates !== null) { if ($object->updates instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($object->updates); } }
                return;
            ...
            case \ProtoBrick\MTProtoClient\Generated\Types\Base\ChannelAdminLogEventActionEditMessage::class:
                if ($object->prevMessage !== null) { $this->collect($object->prevMessage, $manager); }
                if ($object->newMessage !== null) { $this->collect($object->newMessage, $manager); }
                return;
            ...
            case \ProtoBrick\MTProtoClient\Generated\Types\Base\ChannelAdminLogEvent::class:
                if ($object->action !== null) { $this->collect($object->action, $manager); }
                return;

            case \ProtoBrick\MTProtoClient\Generated\Types\Channels\AdminLogResults::class:
                if ($object->events !== null) { foreach ($object->events as $item) { $this->collect($item, $manager); } }
                if ($object->chats !== null) { foreach ($object->chats as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                if ($object->users !== null) { foreach ($object->users as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                return;

            case \ProtoBrick\MTProtoClient\Generated\Types\Base\RecentMeUrlChatInvite::class:
                if ($object->chatInvite !== null) { $this->collect($object->chatInvite, $manager); }
                return;

            case \ProtoBrick\MTProtoClient\Generated\Types\Help\RecentMeUrls::class:
                if ($object->urls !== null) { foreach ($object->urls as $item) { $this->collect($item, $manager); } }
                if ($object->chats !== null) { foreach ($object->chats as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                if ($object->users !== null) { foreach ($object->users as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                return;
            ...
            case \ProtoBrick\MTProtoClient\Generated\Types\Base\UrlAuthResultRequest::class:
                if ($object->bot !== null) { if ($object->bot instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($object->bot); } }
                return;
            ...
            case \ProtoBrick\MTProtoClient\Generated\Types\Base\MessageReplyHeader::class:
                if ($object->replyMedia !== null) { $this->collect($object->replyMedia, $manager); }
                return;
            ...
            case \ProtoBrick\MTProtoClient\Generated\Types\Users\UserFull::class:
                if ($object->fullUser !== null) { $this->collect($object->fullUser, $manager); }
                if ($object->chats !== null) { foreach ($object->chats as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                if ($object->users !== null) { foreach ($object->users as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                return;
            ...
            case \ProtoBrick\MTProtoClient\Generated\Types\Stories\AllStories::class:
                if ($object->peerStories !== null) { foreach ($object->peerStories as $item) { $this->collect($item, $manager); } }
                if ($object->chats !== null) { foreach ($object->chats as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                if ($object->users !== null) { foreach ($object->users as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                return;

            case \ProtoBrick\MTProtoClient\Generated\Types\Stories\Stories::class:
                if ($object->stories !== null) { foreach ($object->stories as $item) { $this->collect($item, $manager); } }
                if ($object->chats !== null) { foreach ($object->chats as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                if ($object->users !== null) { foreach ($object->users as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                return;
            ...
            case \ProtoBrick\MTProtoClient\Generated\Types\Stories\StoryViewsList::class:
                if ($object->views !== null) { foreach ($object->views as $item) { $this->collect($item, $manager); } }
                if ($object->chats !== null) { foreach ($object->chats as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                if ($object->users !== null) { foreach ($object->users as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                return;
            ...
            case \ProtoBrick\MTProtoClient\Generated\Types\Stats\PublicForwards::class:
                if ($object->forwards !== null) { foreach ($object->forwards as $item) { $this->collect($item, $manager); } }
                if ($object->chats !== null) { foreach ($object->chats as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                if ($object->users !== null) { foreach ($object->users as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                return;
            ...
            case \ProtoBrick\MTProtoClient\Generated\Types\Stories\StoryReactionsList::class:
                if ($object->reactions !== null) { foreach ($object->reactions as $item) { $this->collect($item, $manager); } }
                if ($object->chats !== null) { foreach ($object->chats as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                if ($object->users !== null) { foreach ($object->users as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                return;
            ...
            case \ProtoBrick\MTProtoClient\Generated\Types\Messages\DialogFilters::class:
                if ($object->filters !== null) { foreach ($object->filters as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                return;
            ...
            case \ProtoBrick\MTProtoClient\Generated\Types\Payments\StarsStatus::class:
                if ($object->history !== null) { foreach ($object->history as $item) { $this->collect($item, $manager); } }
                if ($object->chats !== null) { foreach ($object->chats as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                if ($object->users !== null) { foreach ($object->users as $item) { if ($item instanceof \ProtoBrick\MTProtoClient\TL\Contracts\PeerEntity) { $manager->savePeerEntity($item); } } }
                return;
            ...
            case \ProtoBrick\MTProtoClient\Generated\Types\Bots\PreviewInfo::class:
                if ($object->media !== null) { foreach ($object->media as $item) { $this->collect($item, $manager); } }
                return;
